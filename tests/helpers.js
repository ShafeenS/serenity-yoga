// tests/helpers.js
import {
  initDb, usersDb, coursesDb, sessionsDb, bookingsDb,
} from "../models/_db.js";
...
// Creates a login-capable organiser for tests that need one
export async function seedOrganiser() {
  return UserModel.create({
    name: "Test Organiser",
    email: "organiser@test.local",
    role: "organiser",
    passwordHash: "$2a$12$placeholderHashForTestingOnly000000000000000000000000",
  });
}
